...
Currently in the box: **97 master prompts, 35 agent skills, 4 workflows, 1 tool stack**.
...
| [Finance Analyst Copilot](skills/finance-analyst-copilot/README.md) | Finance & Admin | Understand your monthly numbers and cash position in plain English |
...
| [Ops Automation Planner: AI Business Process Automation](skills/ops-automation-planner/README.md) | Operations & Productivity | Document your business processes, then automate the ones worth automating |
...
| [The Idea Grill](skills/idea-grill/README.md) | Strategy & Planning | Five hostile experts interrogate your idea and score it out of 100 before you build |
| [Accountant Handoff Pack](skills/accountant-handoff-pack/README.md) | Finance & Admin | Send your accountant one clean package instead of forty emails |
...
| [Bookkeeping Copilot](skills/bookkeeping-copilot/README.md) | Finance & Admin | Books that stay categorized and reconciled monthly without dread |
...
| [Content Repurposing Studio](skills/content-repurposing-studio/README.md) | Marketing & Content | One blog post becomes ten pieces of content in your voice |
...
| [Inventory Manager](skills/inventory-manager/README.md) | Operations & Productivity | Know what to reorder and what is dead stock from a pasted spreadsheet |
...
| [Business Plan Copilot](skills/business-plan-copilot/README.md) | Strategy & Planning | A working business plan and financial forecast, built section by section |
| [Quality Control Copilot](skills/quality-control-copilot/README.md) | Operations & Productivity | Growth without the quality slide, caught by spot checks instead of complaints |
...
| [Shift Scheduler Copilot](skills/shift-scheduler-copilot/README.md) | HR & Hiring | The weekly schedule builds itself from memory; you make the judgment calls |
...
| [Scheduled Tasks Copilot](skills/scheduled-tasks-copilot/README.md) | Operations & Productivity | A small roster of scheduled AI tasks that earn their slots, reviewed monthly so the noise gets retired |
