...
- **One command (Claude Code, Cursor, Codex and other agents):** `npx skills add VexloCa/toolbox --skill ops-automation-planner`
...
- **Claude Code:** copy the folder to `~/.claude/skills/ops-automation-planner/`, or to `.claude/skills/` inside a project.
