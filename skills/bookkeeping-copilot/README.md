...
- **One command (Claude Code, Cursor, Codex and other agents):** `npx skills add VexloCa/toolbox --skill bookkeeping-copilot`
...
- **Claude Code:** copy the folder to `~/.claude/skills/bookkeeping-copilot/`, or to `.claude/skills/` inside a project.
