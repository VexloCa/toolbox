...
- **One command (Claude Code, Cursor, Codex and other agents):** `npx skills add VexloCa/toolbox --skill marketing-growth-engine`
...
- **Claude Code:** copy the folder to `~/.claude/skills/marketing-growth-engine/`, or to `.claude/skills/` inside a project.
...
4. Start with one campaign goal ("more bookings in April") and let it build the plan before asking for individual pieces of content.
...
Part of the [Vexlo Toolbox](https://vexlo.ca/toolbox/marketing-growth-engine). Get a free report on where AI can save your business hours every week at [vexlo.ca/audit](https://vexlo.ca/audit).
