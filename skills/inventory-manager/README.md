...
- **One command (Claude Code, Cursor, Codex and other agents):** `npx skills add VexloCa/toolbox --skill inventory-manager`
...
- **Claude Code:** copy the folder to `~/.claude/skills/inventory-manager/`, or to `.claude/skills/` inside a project.
