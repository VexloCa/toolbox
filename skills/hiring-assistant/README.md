...
- **One command (Claude Code, Cursor, Codex and other agents):** `npx skills add VexloCa/toolbox --skill hiring-assistant`
...
- **Claude Code:** copy the folder to `~/.claude/skills/hiring-assistant/`, or to `.claude/skills/` inside a project.
...
4. Build the rubric and interview kit before posting the job. The skill enforces rubric-before-review, and it only works if the rubric exists before applications arrive.
...
Part of the [Vexlo Toolbox](https://vexlo.ca/toolbox/hiring-assistant). Get a free report on where AI can save your business hours every week at [vexlo.ca/audit](https://vexlo.ca/audit).
