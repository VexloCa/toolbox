...
- **One command (Claude Code, Cursor, Codex and other agents):** `npx skills add VexloCa/toolbox --skill meeting-ops-assistant`
...
- **Claude Code:** copy the folder to `~/.claude/skills/meeting-ops-assistant/`, or to `.claude/skills/` inside a project.
