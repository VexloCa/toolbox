...
Run this on your negative AND your 5-star feedback together, not just complaints. The marketing-gold phrases almost always come from the happiest customers, and you'll miss them if you only mine tickets that came in as problems. When you want the themes tracked month over month instead of read once, the [Customer Insights Copilot](/toolbox/customer-insights-copilot) skill keeps the ledger, the quote bank, and the churn watch running between batches.
