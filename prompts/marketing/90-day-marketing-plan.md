...
The reasoning behind each section of this prompt, plus a filled-in example plan for a real business shape, is in [How to Build a 90-Day Marketing Plan With AI](/blog/create-90-day-marketing-plan-with-ai).

## How to use it

1. Copy the full prompt into Claude or ChatGPT.
2. Fill in every bracket with real numbers. Vague answers (e.g. "small budget") produce vague plans.
3. Answer the AI's clarifying questions honestly, including about past failures.
4. Once you get the plan, paste the "First 7 Days" checklist into your calendar or task manager immediately.
5. Re-run the prompt every 90 days with updated results from the last quarter in the "what we've tried before" field.
...
Part of the [Vexlo Toolbox](https://vexlo.ca/toolbox/90-day-marketing-plan). Get a free report on where AI can save your business hours every week at [vexlo.ca/audit](https://vexlo.ca/audit).
